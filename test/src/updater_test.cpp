...
TEST(convertToAPIUrl, git_extension)
{
    EXPECT_EQ(updater::convertToAPIUrl(repo_url), "https://api.github.com/repos/Scrappyz/Test-Updater");
}

TEST(convertToAPIUrl, no_git_extesion)
{
    EXPECT_EQ(updater::convertToAPIUrl(repo_url), "https://api.github.com/repos/Scrappyz/Test-Updater");
}
